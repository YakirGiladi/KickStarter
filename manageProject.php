...
<script src="js/manageProject_functions.js"></script>
...
<script>
	...
	$(document).ready(function() {
		...
		if( userType == 2 || userType == 3  ) {
			...
			var body = "<p>You are not authorize</p>";
...
<script>
	$(document).ready(function() {
        var msg = <?php echo isset($_POST['msg']) ? "'".$_POST['msg']."'" : -1; ?>;
		if(msg!= -1) {
...
<body>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<form class="navbar-form navbar-right"  style="margin-left:25%"></form>
			</div>
	...
	<div class="jumbotron">
		<div class="container" style="margin-bottom: -20px;">
			<h1 id="ManageProjectTitle" >Manage Your Projects</h1>
			<p>Home</p>
		</div>
	</div>
